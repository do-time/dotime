...
public class JwtTokenProvider {
    ...
    protected final long EXPIRE_TIME;

    protected Key key;


    public JwtTokenProvider(String secretKey, long expireTime) {
        this.SECRET_KEY = secretKey;
        this.EXPIRE_TIME = expireTime * 1000;
    ...
    public String createToken(Authentication authentication) {
        ...
        Date validity = new Date(now + this.EXPIRE_TIME);
